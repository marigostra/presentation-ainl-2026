...
\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=north east, xshift=-0.15cm, yshift=-0.15cm] at (current page.north east) {%
    \includegraphics[height=0.4cm, keepaspectratio]{ainl_logo.png}};
\end{tikzpicture}}
...
\item vs. GRU: 93.88\% | vs. BERT: ~97.6\%
...
\begin{itemize}
\item Open dictionary support
\item Fully parallelizable (no RNNs)
\item Trains on consumer GPUs
\item No massive pre-training required
\item Fast inference \& low memory consuption
\end{itemize}
\end{frame}
